...
An interactive Power BI dashboard analyzing global sales transactions with geographic segmentation and shipping insights.
# Global Superstore Sales Analysis – Power BI Dashboard
## Project Overview
This project presents an interactive Power BI dashboard developed to analyze sales transactions of a global retail store with branches across different countries, regions, and markets.
